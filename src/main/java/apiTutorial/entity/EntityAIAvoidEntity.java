...
public class EntityAIAvoidEntity extends EntityAIBase
{
	...
	private double p_i1616_4_;
	private double p_i1616_6_;
    private static final String __OBFID = "CL_00001574";

    public EntityAIAvoidEntity(EntityCreature p_i1616_1_, Class p_i1616_2_, float p_i1616_3_)
    {
    ...
    {
    	IsActiveFunction isRunning = (entity) -> {
    		return ObsidianAPIUtil.isEntityMoving(entity);
    	};
    	
    	AnimationRegistry.registerEntity(EntityImpala.class, "saiga");
    	AnimationRegistry.registerAnimation("saiga", "run", impalaRun, 0, true, isRunning);

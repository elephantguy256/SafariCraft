...
public class EntityAfricanWildDog extends EntityTameable
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityAfricanWildDog.AIAvoidEntity(this, EntityLlama.class, 24.0F, 1.5D, 1.5D));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityAfricanWildDog.class);
    }
    ...
    {
        EntityAfricanWildDog entitywolf = new EntityAfricanWildDog(this.world);
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner)
    {
        ...
        {
            if (target instanceof EntityAfricanWildDog)
            {
                EntityAfricanWildDog entitywolf = (EntityAfricanWildDog)target;
    ...
    {
        private final EntityAfricanWildDog wolf;

        public AIAvoidEntity(EntityAfricanWildDog wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityAfricanWildDog.this.rand.nextInt(5);
        }
        ...
        {
            EntityAfricanWildDog.this.setAttackTarget((EntityLivingBase)null);

...
public class EntityAfricanLionFemale extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityAfricanLionFemale.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityAfricanLionFemale.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityAfricanLionFemale.class, DataSerializers.VARINT);
    ...
    public EntityAfricanLionFemale(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityAfricanLionFemale.AIAvoidEntity(this, EntityLlama.class, 24.0F, 1.5D, 1.5D));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityAfricanLionFemale.class);
    }
    ...
    protected SoundEvent getAmbientSound()
    {
        ...
        {
            return this.isTamed() && ((Float)this.dataManager.get(DATA_HEALTH_ID)).floatValue() < 10.0F ? SoundEvents.ENTITY_WOLF_WHINE :  SoundEvents2.LION;
        }
        else
        {
            return  SoundEvents2.LION;
    ...
    public EntityAfricanLionFemale createChild(EntityAgeable ageable)
    {
        EntityAfricanLionFemale entitywolf = new EntityAfricanLionFemale(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityAfricanLionFemale))
        {
            return false;
        }
        else
        {
            EntityAfricanLionFemale entitywolf = (EntityAfricanLionFemale)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner)
    {
        ...
        {
            if (target instanceof EntityAfricanLionFemale)
            {
                EntityAfricanLionFemale entitywolf = (EntityAfricanLionFemale)target;
    ...
    {
        private final EntityAfricanLionFemale wolf;

        public AIAvoidEntity(EntityAfricanLionFemale wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityAfricanLionFemale.this.rand.nextInt(5);
        }
        ...
        {
            EntityAfricanLionFemale.this.setAttackTarget((EntityLivingBase)null);

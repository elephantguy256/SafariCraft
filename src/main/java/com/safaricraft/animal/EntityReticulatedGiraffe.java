...
public class EntityReticulatedGiraffe extends EntityAnimal
{
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityReticulatedGiraffe.class);
    }
    ...
    public EntityReticulatedGiraffe createChild(EntityAgeable ageable)
    {
        return new EntityReticulatedGiraffe(this.world);
    }

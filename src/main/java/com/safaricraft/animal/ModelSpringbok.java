 ...
 */
public class ModelSpringbok extends ModelBase {
    ...
    public ModelSpringbok() {
        this.textureWidth = 120;
        this.textureHeight = 90;
        this.frontkneeright_2 = new ModelRenderer(this, 56, 50);
        this.frontkneeright_2.setRotationPoint(0.7F, 4.0F, 9.5F);
        this.frontkneeright_2.addBox(-0.6F, -1.0F, -1.8F, 4, 10, 4, 0.0F);
        this.setRotateAngle(frontkneeright_2, 0.22759093446006054F, 0.0F, 0.0F);
        ...
        this.hormbottomright.setRotationPoint(1.0F, 2.3F, 3.8F);
        ...
        this.hormbottomright_1.setRotationPoint(3.0F, -0.6F, 0.0F);
        this.hormbottomright_1.addBox(0.0F, 0.0F, 0.0F, 1, 5, 2, 0.0F);
        this.headback = new ModelRenderer(this, 18, 20);
        this.headback.setRotationPoint(-1.0F, 3.9F, -4.1F);
        this.headback.addBox(0.0F, 0.0F, 0.0F, 6, 5, 6, 0.0F);
        this.setRotateAngle(headback, 1.0016444577195458F, 0.0F, 0.0F);
        ...
        this.frontkneeright_1.setRotationPoint(7.6F, 4.8F, 8.6F);
        this.frontkneeright_1.addBox(-1.7F, -1.0F, 0.1F, 4, 10, 4, 0.0F);
        this.setRotateAngle(frontkneeright_1, 0.22759093446006054F, 0.0F, 0.0F);
        this.frontlegright = new ModelRenderer(this, 87, 39);
        this.frontlegright.setRotationPoint(0.1F, 7.5F, 2.6F);
        this.frontlegright.addBox(-1.1F, 0.0F, -1.6F, 3, 12, 3, 0.0F);
        this.setRotateAngle(frontlegright, -0.31869712141416456F, 0.0F, 0.0F);
        ...
        this.frontlegright_1.setRotationPoint(0.6F, 7.5F, 0.8F);
        this.frontlegright_1.addBox(-1.1F, 0.0F, -1.6F, 3, 12, 3, 0.0F);
        this.setRotateAngle(frontlegright_1, -0.27314402793711257F, 0.0F, 0.0F);
        this.neckbottom = new ModelRenderer(this, -1, -1);
        this.neckbottom.setRotationPoint(3.0F, -6.7F, -4.4F);
        this.neckbottom.addBox(0.0F, 0.0F, 0.0F, 4, 6, 13, 0.0F);
        this.setRotateAngle(neckbottom, -0.7740535232594852F, 0.0F, 0.0F);
        this.bodymiddle = new ModelRenderer(this, 8, 64);
        this.bodymiddle.setRotationPoint(-6.0F, 8.9F, -8.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GlStateManager.scale(0.6D, 0.7D, 0.6D);
        GlStateManager.translate(-this.bodymiddle.offsetX, -this.bodymiddle.offsetY, -this.bodymiddle.offsetZ);
        GlStateManager.translate(-this.bodymiddle.rotationPointX * f5, -this.bodymiddle.rotationPointY * f5, -this.bodymiddle.rotationPointZ * f5);

...
public class EntityAfricanLionMale extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityAfricanLionMale.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityAfricanLionMale.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityAfricanLionMale.class, DataSerializers.VARINT);
    ...
    public EntityAfricanLionMale(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityAfricanLionMale.AIAvoidEntity(this, EntityLlama.class, 24.0F, 1.5D, 1.5D));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityAfricanLionMale.class);
    }
    ...
    public EntityAfricanLionMale createChild(EntityAgeable ageable)
    {
        EntityAfricanLionMale entitywolf = new EntityAfricanLionMale(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityAfricanLionMale))
        {
            return false;
        }
        else
        {
            EntityAfricanLionMale entitywolf = (EntityAfricanLionMale)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner)
    {
        ...
        {
            if (target instanceof EntityAfricanLionMale)
            {
                EntityAfricanLionMale entitywolf = (EntityAfricanLionMale)target;
    ...
    {
        private final EntityAfricanLionMale wolf;

        public AIAvoidEntity(EntityAfricanLionMale wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityAfricanLionMale.this.rand.nextInt(5);
        }
        ...
        {
            EntityAfricanLionMale.this.setAttackTarget((EntityLivingBase)null);

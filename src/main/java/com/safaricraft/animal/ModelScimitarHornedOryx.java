 ...
 */
public class ModelScimitarHornedOryx extends ModelBase {
    ...
    public ModelRenderer hormtop_2;
    public ModelRenderer hormtop_3;

    public ModelScimitarHornedOryx() {
        ...
        this.hormtop_3 = new ModelRenderer(this, 31, 0);
        this.hormtop_3.setRotationPoint(0.0F, 9.7F, -0.1F);
        this.hormtop_3.addBox(0.0F, 0.0F, 0.1F, 1, 9, 1, 0.0F);
        this.setRotateAngle(hormtop_3, -0.27314402793711257F, 0.0F, 0.0F);
        ...
        this.hormtop_1.setRotationPoint(0.0F, 9.7F, -0.1F);
        this.hormtop_1.addBox(0.0F, 0.0F, 0.1F, 1, 9, 1, 0.0F);
        this.setRotateAngle(hormtop_1, -0.27314402793711257F, 0.0F, 0.0F);
        this.hormtop_2 = new ModelRenderer(this, 31, 0);
        this.hormtop_2.setRotationPoint(0.0F, 6.7F, 0.5F);
        this.hormtop_2.addBox(0.0F, 0.0F, 0.0F, 1, 10, 1, 0.0F);
        this.setRotateAngle(hormtop_2, -0.18203784098300857F, 0.0F, 0.0F);
        ...
        this.hormmid_1 = new ModelRenderer(this, 41, 0);
        this.hormmid_1.setRotationPoint(0.0F, 3.5F, 0.0F);
        this.hormmid_1.addBox(0.0F, 0.0F, 0.0F, 1, 7, 2, 0.0F);
        this.setRotateAngle(hormmid_1, -0.22759093446006054F, 0.0F, 0.0F);
        ...
        this.bodymiddle.setRotationPoint(-6.0F, -4.4F, -10.7F);
        ...
        this.necktop.setRotationPoint(1.0F, 0.5F, -4.6F);
        this.necktop.addBox(0.0F, 0.0F, 0.0F, 5, 7, 11, 0.0F);
        ...
        this.hormbottomright_1.setRotationPoint(2.7F, 0.0F, 0.0F);
        ...
        this.neckbottom.setRotationPoint(1.5F, -2.1F, -2.1F);
        this.neckbottom.addBox(0.0F, 0.0F, 0.0F, 7, 8, 8, 0.0F);
        this.setRotateAngle(neckbottom, -0.5918411493512771F, 0.0F, 0.0F);
        this.hormtop = new ModelRenderer(this, 31, 0);
        this.hormtop.setRotationPoint(0.0F, 6.7F, 0.5F);
        this.hormtop.addBox(0.0F, 0.0F, 0.0F, 1, 10, 1, 0.0F);
        this.setRotateAngle(hormtop, -0.18203784098300857F, 0.0F, 0.0F);
        ...
        this.headback.setRotationPoint(-1.0F, 3.8F, -5.8F);
        ...
        this.hormbottomright.setRotationPoint(1.5F, 1.9F, 3.0F);
        this.hormbottomright.addBox(0.0F, 0.0F, 0.0F, 1, 4, 2, 0.0F);
        this.setRotateAngle(hormbottomright, 2.231054382824351F, 0.0F, 0.0F);
        ...
        this.hormmid = new ModelRenderer(this, 41, 0);
        this.hormmid.setRotationPoint(0.0F, 3.5F, 0.0F);
        this.hormmid.addBox(0.0F, 0.0F, 0.0F, 1, 7, 2, 0.0F);
        this.setRotateAngle(hormmid, -0.22759093446006054F, 0.0F, 0.0F);
        this.bodymiddle.addChild(this.frontkneeleft);
        this.hormtop_2.addChild(this.hormtop_3);
        this.bodymiddle.addChild(this.frontkneeright);
        this.frontlegleft.addChild(this.frontfootleft);
        this.hormtop.addChild(this.hormtop_1);
        this.hormmid_1.addChild(this.hormtop_2);
        ...
        this.neckbottom.addChild(this.necktop);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GlStateManager.scale(0.9D, 1.1D, 0.9D);
        GlStateManager.translate(-this.bodymiddle.offsetX, -this.bodymiddle.offsetY, -this.bodymiddle.offsetZ);
        GlStateManager.translate(-this.bodymiddle.rotationPointX * f5, -this.bodymiddle.rotationPointY * f5, -this.bodymiddle.rotationPointZ * f5);

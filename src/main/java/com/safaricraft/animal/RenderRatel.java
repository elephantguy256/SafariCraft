...
public class RenderRatel extends RenderLiving<EntityHoneyBadger>{
	
    private ResourceLocation mobTexture = new ResourceLocation("ec:textures/entity/new/ratel.png");

package com.safaricraft.interactions;
...
public abstract class EntityAIInteractGlass extends EntityAIBase
{
    ...
    public EntityAIInteractGlass(EntityLiving entityIn)
    {
